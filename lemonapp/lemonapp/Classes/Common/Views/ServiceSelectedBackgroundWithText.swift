//
//  ServiceSelectedBackgroundWithText.swift
//  lemonapp
//
...
class ServiceSelectedBackgroundWithText: UIView {
    ...
    fileprivate func initialize() {
        ...
        if let view = Bundle.main.loadNibNamed("ServiceSelectedBackgroundWithText", owner: self, options: nil)![0] as? UIView {
