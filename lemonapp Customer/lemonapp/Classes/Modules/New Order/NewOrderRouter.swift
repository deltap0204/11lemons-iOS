...
final class NewOrderRouter: NSObject {
    ...
    func showNewOrderFlowFromViewController(_ fromViewController: UIViewController, editedOrder: Order? = nil) {
        ...
        if let detailedOrderScreen = storyboard.instantiateViewControllerWithIdentifier(.DetailedOrderScreen) as? DetailedNewOrderViewController {
            ...
            detailedOrderScreen.viewModel = DetailedNewOrderViewModel(editedOrder: editedOrder)
