//
//  MaterialSelectedBackgroundWithText.swift
//  lemonapp
//
...
class MaterialSelectedBackgroundWithText: UIView {
    ...
    fileprivate func initialize() {
        ...
        if let view = Bundle.main.loadNibNamed("MaterialSelectedBackgroundWithText", owner: self, options: nil)![0] as? UIView {
