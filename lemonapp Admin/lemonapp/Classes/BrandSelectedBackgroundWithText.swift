//
//  BrandSelectedBackgroundWithText.swift
//  lemonapp
//
...
class BrandSelectedBackgroundWithText: UIView {
    ...
    fileprivate func initialize() {
        ...
        if let view = Bundle.main.loadNibNamed("BrandSelectedBackgroundWithText", owner: self, options: nil)![0] as? UIView {
