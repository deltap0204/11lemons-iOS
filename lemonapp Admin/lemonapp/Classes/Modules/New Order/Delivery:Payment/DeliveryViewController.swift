...
final class DeliveryViewController : UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let viewModel = viewModel {
            ...
            promocodeView.isUserInteractionEnabled = false
            addressField.isUserInteractionEnabled = false
            paymentField.isUserInteractionEnabled = false
        }
...
//    }
    ...
    func bindViewModel(_ viewModel: DeliveryViewModel) {
        ...
        self.orderDetailsButton.isEnabled = true
        self.orderDetailsButton.tintColor = UIColor.white
